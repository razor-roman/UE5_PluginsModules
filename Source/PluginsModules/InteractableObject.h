...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnInteractionFinished, AActor*/*InteractObject*/,
	AActor*/*InteractInstigator*/);
/**
 * 
 */
class PLUGINSMODULES_API IInteractableObject
{
	GENERATED_BODY()
