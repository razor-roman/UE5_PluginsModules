...
#include "EditorModeInteractiveTool.generated.h"


/**
 * Builder for UEditorModeInteractiveTool
 */
UCLASS()
class EDITORMODE_API UEditorModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UEditorModeInteractiveTool
 */
UCLASS(Transient)
class EDITORMODE_API UEditorModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UEditorModeInteractiveToolProperties();
 ...
 */
UCLASS()
class EDITORMODE_API UEditorModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UEditorModeInteractiveToolProperties> Properties;
	

protected:
	UWorld* TargetWorld = nullptr;		// target World we will raycast into
	UEditorModeEditorMode* EditorMode=nullptr;
